...
run_name = "enformer_celltyping_split"
...
save_path = f"{SAVE_PATH}/final_models/{run_name}.h5"
...
print(model.summary())
#Trainable params: 1,689,255,660
...
# 7. --- Save the model ------------------------------------------------
model.save_weights(save_path) # want it as h5 weights to use for training initialisation