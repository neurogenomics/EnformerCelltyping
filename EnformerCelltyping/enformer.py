...
"""
Adapation of the Tensorflow/Sonnet implementation of Enformer model.
...
Below is modified to be a TF model rather than a sonnet model to make fine-tuning
easier.
"""
import inspect
from typing import Any, Callable, Dict, Optional, Text, Union, Iterable

import EnformerCelltyping.attention_module as attention_module
import numpy as np
...
class Enformer(keras.Model):
  ...
  def call(self, inputs: tf.Tensor,
               is_training=True) -> Dict[str, tf.Tensor]:
